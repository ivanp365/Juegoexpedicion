...
const Map<String, String> veredaPines = {
  'San Juan Bajo': 'assets/images/pin_sanjuanbajo.webp',
  'San Juan Alto': 'assets/images/pin_sanjuanalto.webp',
  'La Joseña': 'assets/images/pin_lajosena.webp',
  'Tosoabí': 'assets/images/pin_tosoabi.webp',
  'Daza': 'assets/images/daza.webp',
  'Chachatoy': 'assets/images/pin_chachatoy.webp',
  'Pinasaco': 'assets/images/pin_pinasaco.webp',
  'San Antonio de Aranda': 'assets/images/pin_sanantonio.webp',
  'Tescual': 'assets/images/pin_tescual.webp',
};
...
class TesorosMapaScreen extends ConsumerStatefulWidget {
  const TesorosMapaScreen({super.key});

  @override
  ConsumerState<TesorosMapaScreen> createState() => _TesorosMapaScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return BgmScope(mode: BgmMode.home, child: Scaffold(
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          Image.asset('assets/images/mapa_morasurco_fondo.webp', fit: BoxFit.cover),
          ...
          Positioned(
            ...
            child: Center(
              child: FloatingTitleAnimation(
                child: Image.asset('assets/images/titulo_tesoros.webp', height: 100, fit: BoxFit.contain),
              ),
            ),
          ),
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(builder: (_) => const TesorosColeccionScreen()));
                  },
                  child: Container(
...
class _PinVeredaAnimadoState extends ConsumerState<_PinVeredaAnimado> with SingleTickerProviderStateMixin {
  ...
  @override Widget build(BuildContext context) {
    ...
    final rutaImagen = veredaPines[widget.vereda] ?? 'assets/images/pin_sanjuanbajo.webp';
