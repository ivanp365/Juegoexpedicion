      ...
      body: SizedBox(
        ...
        child: Stack(
          children: [
            ...
            Image.asset('assets/images/fondo_categoria.webp', fit: BoxFit.fill, width: size.width, height: size.height),
            ...
            Positioned(
              ...
              child: FloatingTitleAnimation(
                child: Image.asset('assets/images/titulo_pregunta.webp', fit: BoxFit.contain),
              ),
            ),
                ...
                child: LayoutBuilder(
                  builder: (context, marco) {
                    return Stack(
                      ...
                      children: [
                        Image.asset('assets/images/marco_tesoro.webp', fit: BoxFit.fill, width: double.infinity, height: double.infinity),
                        
                        Positioned(
                          top: marco.maxHeight * 0.09,
                          bottom: marco.maxHeight * 0.26,
                          child: Image.asset(
                            'assets/images/tesoros/$nombreArchivo.webp',
                            fit: BoxFit.contain,
            ...
            Positioned(
              ...
              child: BouncingCard(
                imagePath: 'assets/images/cat_provision.webp',
            ...
            Positioned(
              ...
              width: size.width * 0.34,
              child: BouncingCard(
                imagePath: 'assets/images/cat_regulacion.webp',
            ...
            Positioned(
              ...
              width: size.width * 0.34,
              child: BouncingCard(
                imagePath: 'assets/images/cat_soporte.webp',
            ...
            Positioned(
              ...
              width: size.width * 0.34,
              child: BouncingCard(
                imagePath: 'assets/images/cat_cultural.webp',
