              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    flex: 8,
                    child: Image.asset(
                            'assets/images/letreroexpedicionambiental.webp',
                            fit: BoxFit.contain)
                        .animate(
                            onPlay: (controller) =>
                  ...
                  Expanded(
                    ...
                    child: Row(
                      ...
                      children: [
                        _GameCard(
                          image: 'assets/images/cardclasificacion.webp',
                          delay: 0,
                          onTap: () {
                        ...
                        _GameCard(
                          image: 'assets/images/cardlombricarrera1.webp',
                          delay: 150,
                          onTap: () {
                            AudioManager.playSfx('button_click.wav');
                            Navigator.of(context).push(
                        ...
                        _GameCard(
                          image: 'assets/images/cardtesorosambientales.webp',
                          delay: 300,
                          onTap: () {
                            AudioManager.playSfx('button_click.wav');
                            Navigator.of(context).push(
